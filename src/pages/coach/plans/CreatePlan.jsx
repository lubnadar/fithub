            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 max-w-4xl w-full max-h-[80vh] overflow-y-auto border border-white/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {workoutLibrary.map(workout => (
                        <div
                            key={workout.id}
                            className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:border-cyan-400/50 transition-all duration-300 cursor-pointer hover:scale-105"
                ...
                <div className="mb-8">
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-cyan-400/50 transition-all duration-300"
                        />
                    </div>
                </div>
                            ...
                            {expandedDay === day && (
                                <div className="px-6 pb-6 space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 border-2 border-dashed border-white/20 rounded-xl text-white/60 hover:border-cyan-400/50 hover:text-cyan-400 transition-all duration-300 flex items-center justify-center gap-2"
                                    >
                                        <Plus size={20} />
                                        Add Workout
                                    </button>
                                        ...
                                        <div className="space-y-3">
                                            {planDays[day].map((workout, index) => (
                                                <div
                                                    ...
                                                    className={`flex items-center gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-cyan-400/50 transition-all duration-300 cursor-move ${dragOverIndex === index ? 'border-cyan-400 bg-cyan-400/10' : ''
                                                        }`}
                                                >
                                    ...
                                    <div className="flex gap-3 pt-4">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 font-medium"
                                        >
