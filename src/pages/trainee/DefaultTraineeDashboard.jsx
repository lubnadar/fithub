...
import { Users, MessageCircle, HelpCircle, Star, TrendingUp, Calendar, FileText } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* My Request Section - تم تغيير اللون إلى نفس لون Your Activity */}
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg">
                  <FileText className="w-5 h-5 text-white" />
                </div>
                <h2 className="text-xl font-bold text-white">My Request</h2>
              </div>
              <p className="text-gray-300 text-sm mb-4">
                Check the status of your subscription request and track your application progress.
              </p>
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-4 text-center border border-purple-500/30 mb-4">
                <div className="inline-block px-3 py-1 bg-yellow-500/20 border border-yellow-500/30 rounded-full mb-2">
                  <span className="text-yellow-300 text-xs font-medium">Pending Review</span>
                </div>
                <p className="text-gray-300 text-sm">Your subscription request is being reviewed</p>
              </div>
              <Link
                to="/trainee/my-requests"
                className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 px-4 rounded-lg font-medium hover:from-purple-600 hover:to-pink-600 transform hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-pink-500/25 inline-block text-center"
              >
                Show Request
              </Link>
            </div>
